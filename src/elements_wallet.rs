...
use lwk_wollet::elements::{Address, AddressParams, Transaction, encode::serialize_hex};
use lwk_wollet::{TxBuilder, Wollet, WolletBuilder, WolletDescriptor};
use sqlx::PgPool;
...
impl LiquidFederationWallet {
    ...
    pub async fn build_proposal(
        ...
        let coin_selection_json = serde_json::json!({
            ...
            "note": "LWK-driven coin selection; details deliberately elided in v1.",
        });
